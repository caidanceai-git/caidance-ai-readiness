 ...
 * Description: See what AI says about your site — and fix it. Scans your WordPress site for AI-readiness signals (schema, llms.txt, AI crawler access), shows your CDI-aligned 0–60 score with the top 3 fixes, and can apply the first fix (llms.txt) with your approval. Powered by Caidance.
 * Version:     1.2.0
...
define('CAIDANCE_AIR_VERSION', '1.2.0');
